%TODO
% Prediction: Using urls is what caused the logits vs labels issue
% Can probably get Keras working with images as files, rather than urls. Not enough time to request access to images and download and test
% Include code of some of the error messages received
% Mention h5py requirement (update code to show what should be commented and uncommented)
% Cite the newly used source: An Easy Guide to build new TensorFlow Datasets and Estimator with Keras Model
%TODO
